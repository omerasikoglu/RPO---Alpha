...
using System.Collections.Generic;                                         //item'lara kendi ışığını ekle URP ile
using UnityEngine;                                                        //
...
public class ItemWorld : MonoBehaviour
{
    ...
    {
        Transform transform = Instantiate(WorldAssets.Instance.pfItemWorld, position, Quaternion.identity);
